  ...
  render() {
    ...
    return (
      <div
        ...
        className={this.state.open ? "" : "hide-content"}
      >
        ...
        <div
          ...
          style={{ display: "flex", flexGrow: "2", justifyContent: "center" }}
        >
          <Switch>
            <Route
              exact
            ...
            <Route
              exact
              path="/settings"
              render={(props) => <Settings getLogo={this.getLogo} />}
            />
        ...
        {this.state.cookies === "true" ? null : (
          ...
          >
            ...
            >
              ...
              >
                By using Best Basket, you accept the use of cookies on this
                browser.
              </p>
              <p
                style={{
            ...
            >
              <button
                className="button b-alt"
                onClick={this.hideCookies}
                style={{ height: "min-content", marginRight: "10pt" }}
              >
                Close
              </button>
            </div>
